...
const LeafIcon = L.Icon.extend({
   ...
   function onMapClick(e) {
           var mylat = document.getElementById("somefieldscenelat");
           var mylon = document.getElementById("somefieldscenelon");
	   ...
	   if (document.getElementById("lat") && document.getElementById("lon")){
	       ...
	       console.log(e.latlng);
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      $(document).ready(function(){
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              initMap();
                                              if (window.location.pathname==="/" || window.location.pathname==="/add_one_scene"){
						      $.ajax({
...
success:function(data){
    ...
    somefieldscenelat.value=data.latitude;
    somefieldscenelon.value=data.longitude;
    if (String(data.region) !== "undefined"){
